...
net_mov = pd.read_csv("netflix_movies.csv")
net_mov
...
#cleaned csv
net_mov.to_csv("cleaned_data.csv", index = False)
...
print(get_recommendations('Supernatural'))
...
print(get_recommendations_new('my little pony: a new generation', cosine_sim2))

print(get_recommendations_new('Supernatural', cosine_sim2))

print(get_recommendations_new('Naruto', cosine_sim2))
